  ...
  render() {
    return (
      <section className="mybody-section topics-body">
        ...
        <h2>Step 1: Assess Site Data - Select a Priority Topic</h2>
    ...
    topics:
      state.priorities.length===0
        ...
        :state.topics.map(topic => {
          return {
            ...topic,
            authorName: state.priorities.find(a => a.id===topic.priorityLevel).name
          };
        }),
...
function mapDispatchToProps(dispatch) {
  return {
    actions: {
      ...
      loadPriorities: bindActionCreators(authorActions.loadPriorities,dispatch),
